...
/////////////////////////////////////////
    ...
    int a = rand() % (25 - 10 + 1) + 10;
    int b = rand() % (25 - 10 + 1) + 10;
    ...
    if ((mas_a = (int*)malloc(a * sizeof(int))) == NULL ) return 1;
    if ((mas_b = (int*)malloc(b * sizeof(int))) == NULL ) return 1;
    if ((mas_c = (int*)malloc(a * sizeof(int))) == NULL ) return 1;
